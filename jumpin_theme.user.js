// ==UserScript==
// @name         JumpinLlama : 2019 Theme New
...
.thememode .room {
  background-image: var(--thememode-roombg) !important;
...
.hide_header #header_hide_icon {
  position: relative;
  top: -3px;
}

.thememode #header_up, .thememode #header_down {
  color: var(--thememode-bordercolor);
}

.thememode #Toggle_Hide_Header {
  background-color: var(--thememode-bgcolor);
  border-color: var(--thememode-bordercolor);
}

.custommode #Toggle_Hide_Header {
  background-color: var(--custommodebars-bgcolor) !important;
  border-color: var(--custommodebars-bgcolor);
}

.thememode .cams__RoomDescription {
  color: var(--thememode-textcolor);
}

.customemode .cams__RoomDescription {
  color: var(--customemode-textcolor);
}

#Toggle_Hide_Header:hover {
  opacity: 0.6;
}
...
.thememode .profile__Container {
  background-color: var(--thememode-bgcolor);
  border-color: var(--thememode-textcolor);
}
...
.thememode .header {
  background-color: var(--thememode-lightbgcolor);
}

.thememode .full-width--white,
.thememode .fill-height,
.thememode .full-width {
  background-color: var(--thememode-bgcolor);
}

.thememode .room__Item {
  background-color: var(--thememode-lightbgcolor);
}
...
.bubble_chat .chat__MessageBody > span:nth-child(2) {
  margin-left: 10px;
...
.thememode .chat__FeedWrapper {
  background-color: transparent;
  border: 0px;
  background-image: var(--thememode-chatbg);
...
.chat__Message:hover .chat__MessageTimestamp {
  color: #7289DA;
}
...
.thememode .svg-inline--fa, .thememode .fa {
  color: var(--thememode-buttontext);
}

.thememode .mobileHidden {
  color: var(--thememode-buttontext);
}

.thememode .scroll-shadow {
  background: var(--thememode-bgcolor);
  background-color: var(--thememode-bgcolor);
}

.thememode .modal__Body {
  background: var(--thememode-bgcolor);
}

.thememode > .reg_checkmark, .thememode > .check_head {
  color: var(--thememode-bordercolor);
}

.thememode .reg_checkmark {
  background-color: var(--thememode-lightbgcolor);
  border-color: var(--thememode-bordercolor);
}

.thememode .reg_checkmark:after {
  border-color: var(--thememode-bordercolor) !important;
}

.thememode > .reg_checkmark:hover input ~ .checkmark {
  background-color: var(--thememode-bgcolor);
}

/* ------------------------------ THEME_LLAMA_MENU ----------------------------------- */
.thememode .llama_menu .feature_menu {
  color: var(--thememode-textcolor);
}

.thememode #Extra_Menu {
  color: var(--thememode-textcolor);
}

.thememode .feature_menu {
  color: var(--thememode-textcolor);
  background-color: var(--thememode-bgcolor);
  border-color: var(--thememode-bordercolor);
  -webkit-box-shadow: 6px 9px 25px -15px rgba(0,0,0,0.69);
...
.thememode .menu_header {
  background-color: var(--thememode-lightbgcolor);
  color: var(--thememode-textcolor);
}

.thememode .menu_section {
  color: var(--thememode-textcolor);
}

.thememode .settings_header {
  color: var(--thememode-textcolor);
}
/*--END LLAMA MENU--*/
.thememode .roomHeader__LogoText,
.thememode .tabs__Item,
.thememode .tabs__Item.active {
  color: var(--thememode-textcolor);
}

.thememode .cams__InfoCount {
  color: var(--thememode-textcolor);
}

.thememode .cams__InfoLabel {
  color: var(--thememode-textcolor);
}

.thememode .cams__RoomName {
  color: var(--thememode-textcolor);
}

.thememode .roomHeader__UserAction {
  background-color: var(--thememode-bordercolor);
  color: var(--thememode-bgcolor);
  border-color: var(--thememode-bordercolor);
}

.thememode .bubble_chat .chat__MessageHandle {
  color: var(--thememode-lightbgcolor);
}

.thememode .button-default {
  color: var(--thememode-bgcolor);
  background-color: var(--thememode-bordercolor);
}

.thememode .button-white {
  background-color: var(--thememode-bordercolor);
}
...
.thememode .fa-user:before {
  color: var(--thememode-bgcolor);
}

.thememode .userList__UserHandle-current {
  color: var(--thememode-textcolor);
}

.thememode .mediaSources__SourceWrapper {
  background-color: var(--thememode-bordercolor);
}

.thememode .tabs__Item.active::after {
  background-color: var(--thememode-bordercolor);
}

.thememode.ltr_layout .chat__UserList {
  border-color: var(--thememode-bordercolor);
}

.thememode #Chat_Hider::after {
  background: var(--thememode-bordercolor);
}

.thememode #UserList_Hider::after {
  background: var(--thememode-bordercolor);
}

.thememode.ltr_layout #LTR_Toggle::after {
  background: var(--thememode-bordercolor);
}
...
.thememode .modal__Window {
  border: 1px solid var(--thememode-bordercolor);
}

.thememode .chat__HeaderOption {
  border-color: var(--thememode-bordercolor);
  background-color: var(--thememode-bordercolor);
  color: var(--thememode-lightbgcolor);
}

.thememode.bubble_chat .chat__MessageBody {
  background-color: var(--thememode-bgcolor);
  border-color: var(--thememode-lightbgcolor);
  background-image: var(--thememode-messagebg);
}

.thememode .chat__MessageBody-status {
  color: var(--thememode-textcolor);
  background-color: var(--thememode-lightbgcolor);
  border-color: var(--thememode-bordercolor);
}

.thememode .chat__MessageBody-link {
  color: #ff0000;
}

.thememode .chat__MessageTimestamp {
  color: var(--thememode-textcolor);
}

.thememode .chat__Message:hover .chat__MessageTimestamp {
  color: var(--thememode-textcolor);
}

.thememode .roomHeader {
  background-color: transparent;
}

.thememode .privateMessages__Empty {
  background-color: var(--thememode-bgcolor);
}
/* --------- CHANGE NICKNAME --------- */
.thememode .cams {
...
.thememode .modal__Body, .thememode .modal__Footer {
  background-image: var(--thememode-userbg) !important;
  background-color: var(--thememode-bgcolor) !important;
  border-color: #7289DA;
}

.thememode .modal__Header {
  background-image: var(--thememode-userbg) !important;
  background-color: var(--thememode-bordercolor);
  border-color: var(--thememode-bordercolor);
  border-bottom: 0px;
...
.thememode .modal__SubText {
  color: var(--thememode-textcolor) !important;
}
...
.thememode .chat__ShareCopy {
  background-color: var(--thememode-bordercolor);
}
/* --------- CAMERAS --------- */

.thememode .cams__Header {
  background-color: var(--thememode-bgcolor) !important;
  background-image: var(--thememode-userbg) !important;
  border-color: var(--thememode-bordercolor);
}
...
/* --------- CHAT --------- */
.thememode .chat__Header {
  background-image: var(--thememode-chatheaderbg);
...
.thememode .chat__InputWrapper {
  border-color: var(--thememode-bordercolor);
  background-color: var(--thememode-bgcolor);
}

.thememode .input::placeholder {
  color: var(--thememode-textcolor);
}

.thememode .input::focus {
  border-color: var(--thememode-bordercolor);
}
/* --------- USERS LIST --------- */
.thememode .chat__UserList {
  background-image: var(--thememode-userbg);
  background-color: var(--thememode-bgcolor);
}

.thememode .layout--horizontal .chat__UserList {
  border-left-color: var(--thememode-bordercolor);
}

.thememode .chat__UserListItem {
  border-top-color: var(--thememode-bordercolor);
  background-color: var(--thememode-bordercolor);
}

.thememode .chat__UserListItem:hover {
  background-color: var(--thememode-bgcolor);
}

.thememode {
  color: var(--thememode-buttoncolor);
}
...
/* ------------------------------ custom_LLAMA_MENU ----------------------------------- */
.custommode .cams, .custommode .chat {
  background-color: var(--custommodecams-bgcolor);
  border-radius: 0px;
}

.custommode .chat__Feed {
  background-color: var(--custommodechat-bgcolor);
}
...
.custommode .chat__InputAction.button {
...
.custommode .button-white {
  background-color: var(--custommodebutton-bgcolor);
}

.custommode .fa-envelope:before {
  color: var(--custommodebutton-textcolor);
}
...
.custommode .fa-clipboard:before {
  color: var(--custommodebutton-textcolor);
}

.custommode .fa-user:before {
  color: var(--custommode-lightbordercolor);
}

.custommode .userList__UserHandle-current {
  color: white;
}

.custommode .mediaSources__SourceWrapper {
  background-color: var(--custommode-bordercolor);
}

.custommode .tabs__Item.active::after {
  background-color: var(--custommodebutton-bordercolor);
}

.custommode.ltr_layout .chat__UserList {
  border-color: var(--custommode-bordercolor);
}

.custommode #Chat_Hider::after {
  background: #7289da;
}

.custommode #UserList_Hider::after {
  background: #7289da;
}

.custommode.ltr_layout #LTR_Toggle::after {
  background: #7289da;
}
...
.custommode .modal__Window {
  border: 1px solid #7289da;
}

.custommode .chat__HeaderOption {
  border-color: var(--custommodebutton-bordercolor);
  background-color: var(--custommodebutton-bgcolor);
  color: var(--custommodebutton-textcolor);
}

.custommode .fa.fa-gear:before, .custommode .icon--hd {
  color: var(--custommodebutton-textcolor);
}
...
.custommode .chat__Feed {
  border-left-color: var(--custommode-lightbordercolor);
}
...
.custommode .chat__UserListItem {
  background-color: var(--custommodeusername-bgcolor);
  color: var(--custommodeusername-textcolor);
}
...
.layout--horizontal .toggle_chat {
  display: block;
}

.hide_chat .chat__FeedWrapper {
  display: none;
}

.hide_chat .chat__UserList {
  width: 100%;
}

.hide_chat .room.layout--horizontal {
  grid-template-columns: 1fr 1fr 20rem;
}

.hide_userlist .room.layout--horizontal {
  grid-template-columns: 1fr 1fr 40rem;
}
/* ------------------------------ USER_LIST_HIDER ----------------------------------- */
.hide_userlist .chat__UserList {
  display: none;
}
/* ------------------------------ LTR_LAYOUT -----------------------------------*/
...
.hide_chat.hide_userlist .room.layout--horizontal {
  grid-template-columns: 1fr 1fr 0rem;
}

.hide_chat.hide_userlist .chat {
  position: relative;
  top: 260px;
}
...
.hide_chat.hide_userlist .cams__Header {
  padding-right: 150px;
}

.hide_chat .cams__Header {
  padding-right: 150px;
}
/*---------------------------------------------------------LTR-----------------------------------*/
...
.ltr_layout.hide_chat.hide_userlist .room.layout--horizontal {
  grid-template-columns: 0fr 1fr 0rem;
}
...
.checkmark.budsmode {
  background-image: url(https://i.imgur.com/fuLugA8.jpg);
...
#enable_custom_mode > label > input {
  position: relative;
  opacity: 1;
  cursor: pointer;
  height: 20px;
...
.user_bg.cam_repeat_on .roomHeader {
  background-repeat: no-repeat;
}

.user_bg.cam_center_on .roomHeader {
...
.user_bg.cam_repeat_on .cams__ContainerInternal {
  background-repeat: no-repeat;
}

.user_bg.cam_center_on .cams__ContainerInternal {
  background-position: center center;
}

.user_bg.chat_cover_on .chat__FeedWrapper {
  background-size: cover;
}

.user_bg.chat_repeat_on .chat__FeedWrapper {
  background-repeat: no-repeat;
}

.user_bg.chat_center_on .chat__FeedWrapper {
  background-position: center center;
}

.user_bg.userlist_cover_on .chat__UserList {
  background-size: cover;
}

.user_bg.userlist_repeat_on .chat__UserList {
  background-repeat: no-repeat;
}

.user_bg.userlist_center_on .chat__UserList {
  background-position: center center;
}
...
.user_bg .user_bg_settings {
  display: block;
}

/* ------------------------------ LLAMA_CHAT_MENU ----------------------------------- */
.llama_robo.open_llama_chat #Llama_Chat {
  width: 175px;
}
...
.room.layout--horizontal > div.chat > div.chat__Header > div.chat__HeaderOptions > div {
  top: 94px !important;
}
/* ------------------------------ LLAMA_CAM_MENU ----------------------------------- */
...
.user_bg.open_llama_theme #Llama_Theme {
  height: 450px;
  top: 12%;
}

.dark .user_bg_settings {
  border-color: #665c54;
  color: #fbf1c7;
...
.hide_notice #New_Llama_Notice {
  display: block;
}

.dark #New_Llama_Notice {
  color: white;
}
...
#Reset_Llama_Color:focus, #Save_Llama_Color:focus, #Preview_Llama_Color:focus {
  outline: 0;
}

#Save_Llama_Color:hover {
  background-color: green;
}

#Preview_Llama_Color:hover {
...
`)
  ...
  document.addEventListener('input', function (event) {
    ...
    if (event.target.value === 'Default Theme') { Toggle_DefaultTheme() }
    if (event.target.value === 'PINK') { Toggle_Theme('pink') }
    if (event.target.value === 'GREEN') { Toggle_Theme('green') }
    if (event.target.value === 'BLUE') { Toggle_Theme('blue') }
    if (event.target.value === 'MAUVE') { Toggle_Theme('mauve') }
    if (event.target.value === 'ORANGE') { Toggle_Theme('orange') }
    if (event.target.value === 'RED') { Toggle_Theme('red') }
    if (event.target.value === 'PURPLE') { Toggle_Theme('purple') }
    if (event.target.value === 'BLACK') { Toggle_Theme('black') }
    if (event.target.value === 'BUDS') { Toggle_Theme('buds') }
    if (event.target.value === 'SPLAT') { Toggle_Theme('splat') }
...
// ------- SET DROPDOWN CHOICE -------
  ...
  if (theme_status === 'pink') { document.getElementById('theme_wizard').selectedIndex = 2 }
  if (theme_status === 'green') { document.getElementById('theme_wizard').selectedIndex = 3 }
  if (theme_status === 'blue') { document.getElementById('theme_wizard').selectedIndex = 4 }
  if (theme_status === 'mauve') { document.getElementById('theme_wizard').selectedIndex = 5 }
  if (theme_status === 'orange') { document.getElementById('theme_wizard').selectedIndex = 6 }
  if (theme_status === 'red') { document.getElementById('theme_wizard').selectedIndex = 7 }
  if (theme_status === 'purple') { document.getElementById('theme_wizard').selectedIndex = 8 }
  if (theme_status === 'black') { document.getElementById('theme_wizard').selectedIndex = 9 }
  if (theme_status === 'buds') { document.getElementById('theme_wizard').selectedIndex = 10 }
...
function Toggle_Theme (color) {
  ...
  body.classList.remove('custommode')
  if (thememode_status !== color) { localStorage.setItem(thememode_variable, color) }
