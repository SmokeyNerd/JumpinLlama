...
.user_bg.open_llama_theme #Llama_Theme {    height: 282px;top: 41%;}
...
<div class="dropdown__Option dropdown__Option-header">Custom Settings</div>
            <label class="dropdown__Option">
                ...
                <input class="jscolor {zIndex:'5000'}"  type='text' name="server" id="colorSelection1" value="#004D91" style="width: 100px;"></input>
            </label>
            <label class="dropdown__Option">
                <span class="check_head" style="display: inline-block;width: 100px;">Background</span>
                <input class="jscolor {zIndex:'5000'}"  type='text' name="server" id="colorSelection2" value="#CFCFCF" style="width: 100px;"></input>
            </label>
            <label class="dropdown__Option">
                <span class="check_head" style="display: inline-block;width: 100px;">Border</span>
                <input class="jscolor {zIndex:'5000'}"  type='text' name="server" id="colorSelection3" value="#FFFFFF" style="width: 100px;"></input>
            </label>
            <label class="dropdown__Option">
                <span class="check_head" style="display: inline-block;width: 100px;">Text</span>
                <input class="jscolor {zIndex:'5000'}" type='text' name="server" id="colorSelection4" value="#000000" style="width: 100px;"></input>
            </label>
            <label class="button_custom">
                <input id="Reset_Llama_Color" type="button" style="cursor:pointer;border-radius: 10px;width: 30%;border: 1px solid #ccc;" value="RESET"/>
                <input id="Preview_Llama_Color" type="button" style="cursor:pointer;border-radius: 10px;width: 33%;border: 1px solid #ccc;" value="PREVIEW"/>
                <input id="Save_Llama_Color" type="button" style="cursor:pointer;border-radius: 10px;width: 30%;border: 1px solid #ccc;" value="SAVE"/>
            </label>
</div>
...
document.addEventListener('input', function (event) {
    ...
    if (event.target.value === 'CUSTOM') {Toggle_Theme_Custom();}
}, false);
