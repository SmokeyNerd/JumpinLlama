...
if (!window.jscolor) {
  window.jscolor = (function () {
    ...
    "isCanvasSupported": (function () {
      ...
      return Boolean(elm.getContext && elm.getContext("2d"))
    })(),
    ...
    "setClass": function (elm, className) {
      ...
      for (var i = 0; i < classList.length; i = i + 1) {
        if (!jsc.hasClass(elm, classList[i])) {
          elm.className = elm.className + ((elm.className ? " " : "") + classList[i])
        }
      }
    },
    ...
    "setStyle": (function () {
      ...
      var props = {"borderRadius": getSupportedProp([
        "borderRadius",
        "MozBorderRadius",
        "webkitBorderRadius"
      ]),
    ...
    "getPickerDims": function (thisObj) {
      var displaySlider = Boolean(jsc.getSliderComponent(thisObj))
      var dims = [
    ...
    "_pointerMoveEvent": {"mouse": "mousemove",
      "touch": "touchmove"},
    "_pointerEndEvent": {"mouse": "mouseup",
      "touch": "touchend"},
    ...
    "onControlPointerStart": function (e, target, controlName, pointerType) {
      ...
      jsc._pointerOrigin = {"x": abs.x - rel.x,
        "y": abs.y - rel.y}
    ...
    "jscolor": function (targetElement, options) {
      ...
      function drawPicker () {
        ...
        var displaySlider = Boolean(jsc.getSliderComponent(THIS))
    ...
    */
      ...
      // StyleElement
      if (this.styleElement) {
        this.styleElement._jscOrigStyle = {"backgroundImage": this.styleElement.style.backgroundImage,
